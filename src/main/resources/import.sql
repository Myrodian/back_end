...
insert into tb_produto_categoria(id_produto, id_categoria) values (2, 2);
...
insert into tb_produto_categoria(id_produto, id_categoria) values (4, 1);
insert into tb_produto_categoria(id_produto, id_categoria) values (4, 2);
insert into tb_produto_categoria(id_produto, id_categoria) values (5, 1);
